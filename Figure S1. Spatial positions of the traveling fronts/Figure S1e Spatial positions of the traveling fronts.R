...
Data1   <- data.frame(Time = TimeX[18:39], ph_su = Mxph_su$X0[18:39]*30/1000)   #1982-1989
Data2   <- data.frame(Time = TimeX[18:39], su_sp = Mxsu_sp$X1[18:39]*30/1000) #2005-2010
Data3   <- data.frame(Time = TimeX[11:39], ph_sp = Mxph_sp$X0[11:39]*30/1000) #2016-2020
...
p1
lm(ph_su~Time,Data1)
ggsave(p1,filename = "Figure S1e.pdf",width = 6,height = 6,dpi=800)
...
p2
lm(su_sp~Time,Data2)
ggsave(p2,filename = "Figure S1f.pdf",width = 6,height = 6,dpi=800)
...
p3
lm(ph_sp~Time,Data3)
ggsave(p3,filename = "Figure S1g.pdf",width = 6,height = 6,dpi=800)
